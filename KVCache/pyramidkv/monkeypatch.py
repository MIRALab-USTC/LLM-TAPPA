...
from pyramidkv.qwen2_model import qwen2_flash_attn2_forward_PyramidKV, qwen2_flash_attn2_forward_SnapKV, qwen2_flash_attn2_forward_StreamingLLM, qwen2_flash_attn2_forward_H2O, prepare_inputs_for_generation_qwen2_new
...
def replace_qwen2(method):
    ...
    # elif method == "l2norm":
    #     print("Using L2Norm!")
    #     transformers.models.qwen2.modeling_qwen2.Qwen2Attention.forward = qwen2_attn_forward_L2Norm
    #     transformers.models.qwen2.modeling_qwen2.Qwen2FlashAttention2.forward = qwen2_flash_attn2_forward_L2Norm
    #     transformers.models.qwen2.modeling_qwen2.Qwen2SdpaAttention.forward = qwen2_sdpa_attn_forward_L2Norm
    
    # elif method == "adakv":
    #     print("Using AdaKV!")
    #     transformers.models.qwen2.modeling_qwen2.Qwen2Model.forward  = adaptive_Qwen2Model_forward
    #     transformers.models.qwen2.modeling_qwen2.Qwen2Attention.forward = qwen2_flash_attn2_forward_AdaKV
    #     transformers.models.qwen2.modeling_qwen2.Qwen2FlashAttention2.forward = qwen2_flash_attn2_forward_AdaKV
    #     transformers.models.qwen2.modeling_qwen2.Qwen2SdpaAttention.forward = qwen2_flash_attn2_forward_AdaKV

    # elif method == "headkv":
    #     print("Using HeadKV!")
    #     transformers.models.qwen2.modeling_qwen2.Qwen2Model.forward  = adaptive_Qwen2Model_forward
    #     transformers.models.qwen2.modeling_qwen2.Qwen2Attention.forward = qwen2_flash_attn2_forward_HeadKV
    #     transformers.models.qwen2.modeling_qwen2.Qwen2FlashAttention2.forward = qwen2_flash_attn2_forward_HeadKV
    #     transformers.models.qwen2.modeling_qwen2.Qwen2SdpaAttention.forward = qwen2_flash_attn2_forward_HeadKV
