...
from transformers.models.qwen2.modeling_qwen2 import *  # noqa: F403
...
def qwen2_attn_forward_tappa(
    ...
    """
    TAPPA-enabled FlashAttention2 forward for Qwen2.

    This function is intentionally kept close to CAKE's forward, with TAPPA
    ...
    # Flash Attention expects shape [bsz, q_len, heads, head_dim] (transposed in-place below)
