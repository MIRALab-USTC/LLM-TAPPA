...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Compute layer-wise q-similarity scores.")
    ...
    parser.add_argument("--output", default="prune_orders/raw_scores/q_similarity_scores.json")
...
def main() -> None:
    ...
    scores = model.mean_q_similarity()
    payload = {
        "score_type": "q_similarity",
